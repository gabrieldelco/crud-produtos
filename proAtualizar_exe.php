		...
		<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
			...
			<div class="w3-code cssHigh notranslate">
				...
				if ($_FILES['Imagem']['size'] == 0) { // Não recebeu uma imagem binária
					$sql = "UPDATE produto SET descricao_produto = '$descricao', caracteristica_produto = '$caracteristica', codigo_barras = '$codigo_barras', preco_venda = '$preco', unidade_medida = '$unidade', id_categoria = '$categoria' WHERE id_produto = $id";
				} else {
					$imagem = addslashes(file_get_contents($_FILES['Imagem']['tmp_name'])); // Prepara para salvar em BD
					$sql = "UPDATE produto SET descricao_produto = '$descricao', caracteristica_produto = '$caracteristica', codigo_barras = '$codigo_barras', preco_venda = '$preco', unidade_medida = '$unidade', id_categoria = '$categoria', imagem = '$imagem' WHERE id_produto = $id";
				}
