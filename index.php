	...
	<body >  
        <?php
            ...
            if (isset($_SESSION ['login'])) {                               // Se existe usuário logado 
                header("location: /produtos/proListar.php");  // Vai para as funcionalidades do site
                exit();
            }
        ?>
        <!-- Menu Superior -->
        <div class="w3-top" id="LoginCadastro" >
            <div class="w3-row w3-white w3-padding" >
                <div class="w3-half" style="margin:0 0 0 0"><a href="."><img src='imagens/Logo1.jpg' alt='  produtos '></a></div>
                ...
                <div id="id0L" class="w3-modal ">
                    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:400px">
                        ...
                        <form action="login.php" method="POST" class="w3-container w3-card-4 w3-light-grey w3-margin">
                            ...
                            <label class="w3-text-IE"><b>Email do usuário</b></label>
                            <input class="w3-input w3-border w3-margin-bottom" type="text" name="Email" placeholder="login@provedor.com" required>
                    ...
                    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:400px">
                        ...
                        <form action="cadastro.php" method="POST" class="w3-container w3-card-4 w3-light-grey w3-margin">
                            ...
                            <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
                                ...
                                <input class="w3-input w3-border" name="nome" type="text" placeholder="Nome" required>
                                </div>
                            </div>
                            <div class="w3-row w3-section">
                            <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
                                ...
                                <input class="w3-input w3-border" name="Email" type="text"
                                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="login@provedor.com" title="login@provedor.com" required>
                                </div>
                            </div>
                            <div class="w3-row w3-section">
